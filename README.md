change_vtep_on_route_change is Huawei OPS Python script that changes VTEP peer IP in case the route to primary VTEP goes down. Tested on CloudEngine CE6800 switches.
